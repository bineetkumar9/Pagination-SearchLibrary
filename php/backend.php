<?php
	...
	{   
	    ...
	    $keys=array('type','type2','table_name','search_col_name','search_col_email','get_colms','get_id');
	    $value=array(array('string','email','mock_test_tbl','name','email','name,id,email,phone,gender','id'));
	    $query_data=array();
